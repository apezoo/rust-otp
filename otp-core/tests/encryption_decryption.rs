...
fn test_full_vault_workflow() {
    ...
    let mut cmd_init = Command::cargo_bin("otp-cli").expect("Failed to find otp-cli binary");
    cmd_init
        .arg("--vault")
        .arg(&vault_path)
        .arg("vault")
    ...
    let mut cmd_gen = Command::cargo_bin("otp-cli").expect("Failed to find otp-cli binary");
    ...
    let mut cmd_encrypt = Command::cargo_bin("otp-cli").expect("Failed to find otp-cli binary");
    cmd_encrypt
        .arg("--vault")
        .arg(&vault_path)
        .arg("encrypt")
    ...
    // 5. Decrypt the file
    let mut cmd_decrypt = Command::cargo_bin("otp-cli").expect("Failed to find otp-cli binary");
    cmd_decrypt
        .arg("--vault")
        .arg(&vault_path)
        .arg("decrypt")
...
fn test_vault_status_command() {
    ...
    let mut cmd_status = Command::cargo_bin("otp-cli").expect("Failed to find otp-cli binary");
    cmd_status
        .arg("--vault")
        .arg(&vault_path)
        .arg("vault")
...
fn test_pad_list_command() {
    ...
    let mut cmd_list = Command::cargo_bin("otp-cli").expect("Failed to find otp-cli binary");
    cmd_list
        .arg("--vault").arg(&vault_path)
        .arg("pad").arg("list")
        .assert().success()
